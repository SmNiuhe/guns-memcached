package cn.stylefeng.guns.rest.modular.auth.converter;

import cn.stylefeng.guns.rest.common.exception.BizExceptionEnum;
import cn.stylefeng.guns.rest.common.exception.GunsException;
import cn.stylefeng.guns.rest.config.properties.JwtProperties;
import cn.stylefeng.guns.rest.modular.auth.security.DataSecurityAction;
import cn.stylefeng.guns.rest.modular.auth.util.JwtTokenUtil;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        String token = HttpContext.getRequest().getHeader(jwtProperties.getHeader()).substring(7);
